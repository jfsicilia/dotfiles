...
# Don't want Finder to open window when a volume is mounted
...
###############################################################################
# Install custom Automator/AppleScript Services/Applications.                 #
###############################################################################
...
cecho "-- Note that some of these changes require a logout/restart to take
effect." $red
echo "-- Done osx.sh"
